...
> Les builds d’aperçu sont publiées comme GitHub `Prereleases`. Lorsque le canal d’aperçu est activé dans les réglages, PromptHub vérifie les builds prerelease.
>
> `0.5.5-beta.2` valide l’identification prerelease et la résolution de manifeste du flux de mise à jour d’aperçu. Comme cette version est inférieure à `0.5.5` stable en semver, le canal stable ne l’utilise pas comme cible de mise à jour automatique par défaut.
