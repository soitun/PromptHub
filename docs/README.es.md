<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/legeling/PromptHub/releases"><img src="https://img.shields.io/badge/version-v0.5.0-green?style=flat-square" alt="Versión"/></a>
...
### v0.5.0 (Versión actual) 🚀

- [x] **Evaluación de seguridad de Skills**: nuevo escáner estático de riesgo para Skills instalados, Skills de la tienda y resultados del CLI
- [x] **Guardas en la tienda**: se puede revisar antes de añadir, el auto-chequeo sigue desactivado por defecto, `high-risk` pide confirmación y `blocked` se rechaza
- [x] **Auditoría CLI**: `prompthub skill scan` ahora devuelve niveles de riesgo y reglas detectadas
- [x] **Sincronización de documentación**: README, READMEs localizados y metadatos del sitio actualizados a `v0.5.0`
...
### Última versión v0.5.0 (2026-04-09) 🎉

**Seguridad de Skills**

- 🛡️ **Escáner estático de riesgo**: evalúa Skills instalados, Skills de la tienda y resultados del CLI
- 🔒 **Detección de patrones maliciosos**: marca fragmentos shell peligrosos, escalada de privilegios, persistencia, rutas de secretos, ejecución codificada y archivos workflow sospechosos

**Flujo de tienda**

- 🏪 **Revisar antes de añadir**: los Skills de la tienda se pueden evaluar manualmente antes de instalar; el auto-chequeo sigue apagado por defecto
- 🚫 **Guardas de alto riesgo**: `high-risk` exige confirmación y `blocked` se rechaza

**Automatización**

- 🖥️ **Salida de seguridad en CLI**: `prompthub skill scan` ahora devuelve niveles de riesgo y reglas detectadas
- 📚 **Sync de documentos de release**: README, documentos localizados y metadatos del sitio alineados con `v0.5.0`
