...
- Oscuro/Claro/Sistema, varios colores de tema, imágenes de fondo locales, 7 idiomas y multiplataforma
...
> Las builds de vista previa se publican como GitHub `Prereleases`. Al activar el canal preview en Ajustes, PromptHub comprueba builds prerelease.
>
> `0.5.5-beta.2` valida la identificación prerelease y la resolución de manifiestos del flujo de actualización preview. Como en semver queda por debajo de `0.5.5` stable, el canal estable no la usa como destino predeterminado de actualización automática.
