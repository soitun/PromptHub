...
>
> `0.5.5-beta.2` validiert die prerelease-Kennung und Manifestauflösung des Vorschau-Updatepfads. Da diese Version in semver unter `0.5.5` stable liegt, verwendet der Stable-Kanal sie nicht als standardmäßiges automatisches Updateziel.
